...
var EventType = /* @__PURE__ */ ((EventType2) => {
  EventType2["ITEM"] = "ITEM";
  EventType2["SLOT"] = "SLOT";
  return EventType2;
})(EventType || {});
const SlotType = {
  HEADER: "list-header",
...
class VirtualListManager {
  constructor(param, onRangeChangeCallback) {
    __publicField(this, "sizes");
    __publicField(this, "firstRangeTotalSize");
    __publicField(this, "firstRangeAverageSize");
    __publicField(this, "lastCalcIndex");
    __publicField(this, "fixedSizeValue");
  ...
  reset(resetParams = true, resetCallback = true) {
    ...
    if (resetCallback) {
      this.onRangeChangeCallback = void 0;
    }
    if (this.param) {
  ...
  getRange() {
    return __spreadValues({}, this.range);
  }
  isBehind() {
  ...
  saveSize(id, size2) {
    this.sizes.set(id, size2);
    if (this.calcType === "INIT") {
      this.fixedSizeValue = size2;
      this.calcType = "FIXED";
    } else if (this.calcType === "FIXED" && this.fixedSizeValue !== size2) {
  ...
  getIndexOffset(givenIndex) {
    ...
    let offset = 0;
    let indexSize = 0;
    for (let index2 = 0; index2 < givenIndex; index2++) {
      indexSize = this.sizes.get(this.param.uniqueIds[index2]);
      offset = offset + (typeof indexSize === "number" ? indexSize : this.getEstimatedSize());
    }
  ...
  getEstimatedSize() {
    return this.isFixedType() ? this.fixedSizeValue : this.firstRangeAverageSize || this.param.estimatedSize;
  }
}
function useSizeChange(element, horizontal, emitSizeChange) {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    const props = __props;
    const element = ref();
    const emitSizeChanged = (size2) => {
      emit("sizeChanged", props.uniqueKey, size2, EventType.ITEM);
    };
    useSizeChange(element, props.horizontal, emitSizeChanged);
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ref_key: "element",
        ref: element,
        role: "list-item",
        id: __props.uniqueKey + ""
      }, [
        renderSlot(_ctx.$slots, "default", { item: __props.source })
      ], 8, _hoisted_1$1);
    };
  }
});
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    const element = ref();
    const emitSizeChanged = (size2) => {
      emit("sizeChanged", props.uniqueKey, size2, EventType.SLOT);
    };
    useSizeChange(element, props.horizontal, emitSizeChanged);
    return (_ctx, _cache) => {
      return _ctx.$slots.content ? (openBlock(), createElementBlock("div", {
        key: 0,
        ref_key: "element",
        ref: element,
        role: __props.uniqueKey
      }, [
...
var VirtualScroller_vue_vue_type_style_index_0_scoped_true_lang = /* @__PURE__ */ (() => "[role=list-container][data-v-853d9dae]{overflow:auto}\n")();
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    const directionKey = isHorizontal.value ? "scrollLeft" : "scrollTop";
    let virtual;
    let range = ref();
    ...
    const scrollToIndex = (index2) => {
      if (index2 >= props.dataSources.length - 1) {
        scrollToBottom();
      } else {
        const offset = virtual.getOffset(index2);
    ...
    const onChildResize = (id, size2) => {
      virtual.saveSize(id, size2);
      emit("resized", id, size2);
    };
    const onSlotResize = (id, size2) => {
      if (id === SlotType.HEADER) {
        virtual.updateParam("slotHeaderSize", size2);
      } else if (id === SlotType.FOOTER) {
        virtual.updateParam("slotFooterSize", size2);
      }
    };
    ...
    const getUniqueIdFromDataSources = () => {
      return props.dataSources.map((dataSource) => typeof props.dataKey === "function" ? props.dataKey(dataSource) : dataSource[props.dataKey]);
    };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createVNode(_sfc_main$1, {
          "unique-key": unref(SlotType).HEADER,
          horizontal: isHorizontal.value,
          onSizeChanged: onSlotResize
        }, createSlots({ _: 2 }, [
          _ctx.$slots.header ? {
            name: "content",
            fn: withCtx(() => [
        ...
        ]), 1032, ["unique-key", "horizontal"]),
        createBaseVNode("div", {
          role: "group",
          style: normalizeStyle({
            padding: isHorizontal.value ? `0px ${unref(range).padBehind}px 0px ${unref(range).padFront}px` : `${unref(range).padFront}px 0px ${unref(range).padBehind}px`
          })
        }, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(range).end - unref(range).start + 1, (n, i) => {
            return openBlock(), createBlock(_sfc_main$2, {
              key: i,
              horizontal: isHorizontal.value,
              uniqueKey: typeof __props.dataKey === "function" ? __props.dataKey(__props.dataSources[unref(range).start + i]) : __props.dataSources[unref(range).start + i][__props.dataKey],
              source: __props.dataSources[unref(range).start + i],
              onSizeChanged: onChildResize
            }, {
              default: withCtx(() => [
                renderSlot(_ctx.$slots, "default", {
                  item: __props.dataSources[unref(range).start + i],
                  index: unref(range).start + i
                }, void 0, true)
              ]),
              _: 2
            }, 1032, ["horizontal", "uniqueKey", "source"]);
          }), 128))
        ], 4),
        createVNode(_sfc_main$1, {
          "unique-key": unref(SlotType).FOOTER,
          horizontal: isHorizontal.value
        }, createSlots({ _: 2 }, [
          _ctx.$slots.footer ? {
            name: "content",
...
var VirtualScroller = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-853d9dae"]]);
var index = {
  install: (app) => {
    app.component("VirtualScroller", VirtualScroller);
  }
};
export { VirtualScroller, index as default };
